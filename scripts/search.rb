...
def check_query_and_set_defaults(oSearchTweets, query, start_time, end_time, since_id, until_id, max_results, fields)
    ...
    #Fields is optional, defaults to 'id,created_at,author_id,text'.
    if !fields.nil?
...
if __FILE__ == $0  #This script code is executed when running this file.
    ...
    check_query_and_set_defaults(oSearchTweets, $query, $start_time, $end_time, $since_id, $until_id, $max_results, $fields) #TODO: add polling?
    ...
    Utilities.write_file(newest_id_file, newest_id) if newest_id.to_i > 0 #and $poll #TODO: only do this if in polling mode?
